...
class ThreeOfAKindTest {
    ...
    void isSatisfiedSome() throws CardParseException {
        Hand hand = parser.parse(": 2H 2H 2H 4H 5H");

        Optional<Hand> handOptional = new ThreeOfAKind().isSatisfied(hand);
    ...
    void evaluateWIN() throws CardParseException {
        ...
        Outcome outcome = new ThreeOfAKind().evaluate(hand0, hand1);
